...
const restoreQuestions = [
  ...
  },
  {
    ...
    message(params) {
      console.log(`${params.backupDir} has ${params.allDBs.length} databases.`);
  ...
  },
  {
    ...
    when: validate.connected,
    message(params) {
      console.log(`You are about to restore ${params.dbs.length} database(s) from ${params.backupDir} to a couch instance at ${params.url}.`);
